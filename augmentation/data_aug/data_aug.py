...
class addsnow(object):
    def __init__(self, snow_coeff=-1):
        ...
        print("\nselected snow_coeff value - ",self.snow_coeff,"\n")
...
class RandomBrightness(object):
    def __init__(self, gamma=1.2):
        self.gamma = gamma
        print("\nselected gamma value - ",self.gamma,"\n")

    def __call__(self, img, bboxes):
        if self.gamma == 1:
            print("\ngamma value is 1 which represent no change required...!!!")
...
class GaussianFiltering(object):
    def __init__(self, filter_size=5):
        ...
        print("\nselected kernel filter - ",filter_size)
...
class Resize(object):
    ...
    def __call__(self, img, bboxes):
        ...
        new_w = scale*w
        new_h = scale*h
        inp_dim_ht = self.inp_dim[0]   
        inp_dim_w = self.inp_dim[1]   
    
        del_h = (inp_dim_ht - new_h)/2
