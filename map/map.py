...
import numpy as np
import keras2tf
import qvga_inference_320x240 as inference
...
def main(arguments):
    GT_PATH = os.path.abspath(arguments.ground_truth)
    DR_PATH = os.path.abspath(arguments.predictions)
    IMG_PATH = os.path.abspath(arguments.input_images)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-i", "--input_images", required=True,help="Input Images Path")
    parser.add_argument("-g", "--ground_truth", required=True, help="Input Images Path")
    parser.add_argument("-p", "--predictions", required=False,default="./inference_output/predictions", help="Input Images Path")
    parser.add_argument('-na', '--no-animation', help="no animation is shown.", action="store_true")
    parser.add_argument('-np', '--no-plot', help="no plot is shown.", action="store_true")
    parser.add_argument('-q', '--quiet', help="minimalistic console output.", action="store_true")
    parser.add_argument("-h5", "--h5", required=True, help="Input Model Path")
    ...
    args.pb = os.path.abspath('./inference.pb')
