...
def set_anchors(mc):
    ...
    anchor_shapes = np.reshape(
        [np.array([[ 99.81198357, 145.12354972],
       [ 76.6945077 , 104.22115521],
       [ 53.98276497,  86.99677173],
       [ 41.44469093,  68.56454694],
       [ 39.42599437,  55.49811353],
       [ 29.47245127,  51.53564011],
       [ 22.04661535,  35.32657323]]
)] * H * W,
        (H, W, B, 2)
    )
