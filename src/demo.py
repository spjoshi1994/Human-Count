...
tf.app.flags.DEFINE_string(
    'checkpoint', '/home/shubhamjoshi/mobilenetV1_crosslink_nx_vnv/crosslink_humancnt_training/scripts/logs/train_tinyYolo/model.ckpt-68000',
    """Path to the model parameter file.""")
tf.app.flags.DEFINE_string(
    'input_path', '/home/shubhamjoshi/mobilenetV1_crosslink_nx_vnv/dataset_224x224_kitti/training/images/**',
    """Input image or video to be detected. Can process glob input such as """
    """/home/shubhamjoshi/mobilenetV1_crosslink_nx_vnv/crosslink_humancnt_training/data/test/img/22_020826782.jpg""")
tf.app.flags.DEFINE_string(
    'out_dir', './data/outItinyyolo/', """Directory to dump output image or video.""")
tf.app.flags.DEFINE_string(
    'demo_net', 'tinyYolo', """Neural net architecture.""")
