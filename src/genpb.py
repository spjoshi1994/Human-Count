...
def main():
  indexOfModel=0
  dataParas=[['./model.pbtxt',      'image_input',  'image_input',  'conv12/convolution' ,    True,[1,224,224,1]]]
...
if __name__ == '__main__':
  ...
  parser.add_argument("--freeze", required = False, default = False, action = "store_true", help="Freeze graph for inference.")
